package com.bluetel.android.app.individual_assistant.compatibility;
...
import com.bluetel.android.app.individual_assistant.linphone.Contact;
...
public class ApiFivePlus {
	...
	public static Notification createMessageNotification(Context context, String title, String msg, PendingIntent intent) {
		...
		notif.icon = R.drawable.add_contact_icon; //chat_icon_over 
		notif.iconLevel = 0;
